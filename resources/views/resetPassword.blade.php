                            ...
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2 col-sm-12 col-md-12 text-center">
                                    ...
                                    <div class="col-lg-6 offset-lg-3 text-left" data-aos="fade-up" data-aos-delay="300">
                                        ...
                                        @endif
                                        <form  class="form text-dark card box-shadow rounded" action="{{ route('password.email') }}" method="POST"> <!--id="login-form"-->
                                            @csrf
                                            
                                            <div class="form-group">
                                                <label > {{ __('Before proceeding, please check your email for a verification link.') }}
                                        {{ __('If you did not receive the email') }},</label>
                                            </div>
                                            
                                            
                                            <div class="d-flex justify-content-between ">
                                                <div class="form-group">                                                    
                                                <button type="submit"   class="btn btn-circled btn-black">
                                                        {{ __('click here to request another') }}
                                                    </button>
                                                </div>
                                               <!-- <div id="register-link" class="text-right">
                                                    <a href="#" class="btn btn-circled btn-transparent-black">Register</a>
                                                </div>-->
                                            </div>
                                        </form>
                                    </div>
