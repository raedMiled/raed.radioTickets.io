...
<img src="/imagestemplate/full-1600-700shutterstock_177378965.jpg" alt="Featured image" width="1600" height="530">
</div>
</div>
                                    ...
                                    <div class="qt-header-mid qt-vc">
                                        <div class="qt-vi">
                                            <div class="row">
                                                    ...
                                                    <div class="qt-vc">
                                                        <div class="qt-vi">
                                                            ...
                                                            <h3 class="qt-spacer-xs qt-ellipsis qt-t qt-title">
                                                                <a href="{{route('show.deal', ['deal' => $deal->id])}}" class="qt-text-shadow">{{$deal -> name}}</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col s12 m2">
                                                    <a href="{{route('show.deal', ['deal' => $deal->id])}}" class="qt-btn qt-btn-primary bottom right"><i class="dripicons-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
